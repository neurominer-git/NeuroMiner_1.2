...
%                                     end
                                    ...
                                    if ~any(permfl)
                                        ...
                                        [Tx, Psel, Rx, SRx, Cx, ~, PAx] = nk_VisXWeight(inp, MD{h}{m}{k,l}{u}, Ymodel, modelTrL, varind, ParamX, Find, Vind, decompfl);
                                    else
                                        fprintf('\n\t%3g | OptModel =>', u);
                                        ...
                                        if any(sigfl)
                                            ...
                                            [~,~,~,~,~,Vx] = nk_VisXWeight(inp, MD{h}{m}{k,l}{u}, Ymodel, modelTrL, varind, ParamX, Find, Vind, decompfl, false);
                                            ipVx = Vx >= 0; inVx = Vx < 0;
                                            ...
                                            for perms = 1:nperms(1)
                                                ...
                                                [~,~,~,~,~,Vx_perm(:, perms)] = nk_VisXWeight(inp, MD_perm{perms}, Ymodel_perm, L_perm, varind, ParamX, Find, Vind, decompfl, false);
                                            end
