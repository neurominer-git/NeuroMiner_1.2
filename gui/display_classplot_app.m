...
% =========================================================================
function handles = display_classplot_app(h, handles)
...
hText = uitextarea( gcf, 'Value', pss{pssi},'FontSize',11, 'Visible','off'); 
...
figdata.hPanel      = uipanel(gcf, 'Position', hText.Position, 'Visible','off');
...
handles = display_contigmat_app(handles);
