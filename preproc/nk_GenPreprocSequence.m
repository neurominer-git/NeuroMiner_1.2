            ...
            case 'correctnuis'
                ...
                if InputParam.P{ac}.METHOD == 1
                    ...
                    if isfield(TemplParam.ACTPARAM{ac},'BETAEXT') && ~isempty(TemplParam.ACTPARAM{ac}.BETAEXT)
                        ...
                        if isfield(TemplParam.ACTPARAM{ac},'SUBGROUP') && ~isempty(TemplParam.ACTPARAM{ac}.SUBGROUP) && ~isnan(TemplParam.ACTPARAM{ac}.SUBGROUP) && ~isnan(any(TemplParam.ACTPARAM{ac}.SUBGROUP))
