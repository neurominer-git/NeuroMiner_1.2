function h = schemaball(r, lbls, ccolor, ncolor, bcolor)
...
if nargin < 5 || isempty(bcolor);   bcolor = rgb('white');                                        end
...
% Axis settings
set(gca, 'Xlim',xlims,'Ylim',ylims, 'color', bcolor, 'XColor','none','YColor','none',...
         'clim',[-1,1])
