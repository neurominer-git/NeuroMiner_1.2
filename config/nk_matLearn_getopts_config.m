    ...
    case 'get_learner_params'
        ...
        switch algo
            ...
            case 'GRDBST'
                ...
                opt.format = {'i', ...
                            'exponential|deviance|squared error|absolute error|huber|quantile', ... %LATER: add alpha parameter to define alpha-quantile for huber and quantile; for now sklearn GradientBoostingRegressor default = 0.9
                            'e', ...
                            'e', ...
                            'e'};
                opt.sel    = {[], ...
                            {'exponential','deviance','squared_error','absolute_error','huber','quantile'}, ...
                            [],...
                            [],...
                            []};
