    ...
    case 'classification'
        if EXPERT
            sftmenu = ['SVM --------------> LIBSVM|' ...
                       ...
                       'RANDOM FOREST ----> Python sklearn.ensemble.RandomForestClassifier algorithm|' ...
                       'matLearn ---------> Mark Schmidts matLearn library|'...
                       'GLMNET -----------> Hasties library for LASSO/Elastic-net regularized GLMs|' ...
                       'GRADIENT BOOST----> Python sklearn.ensemble.GradientBoostingRegressor algorithm'];
           sftval   = [ 'LIBSVM'; ...
                        'LIBLIN'; ...
                        'ELASVM'; ...
                        'MEXELM'; ...
    ...
    case 'regression'
        if EXPERT
            sftmenu = [ 'SVM --------------> LIBSVM|' ...
                        ...
                        'RANDOM FOREST ----> Python sklearn.ensemble.RandomForestRegressor algorithm|' ...
                        'matLearn ---------> Select a machine learning strategy from Mark Schmidt''s matLearn toolbox|' ...
                        'GLMNET -----------> Hastie''s library for LASSO/Elastic-net regularized GLMs|' ... 
                        'GRADIENT BOOST----> Carlos Beckers gradient boosting algorithm'];
            sftval = ['LIBSVM'; ...
                      'LIBLIN'; ...
                      'MikRVM'; ...
                      'MVTRVR'; ...
