...
if isfield(SVM,'prog')
    ...
    if isfield(SVM,'prog') && ~any(strcmp(SVM.prog,{'kNNMEX','GLMFIT','DECTRE','RNDFOR','MEXELM','ELASVM'}))
    ...
    % in these cases
    if any(strcmp(SVM.prog,{'IMRELF','kNNMEX','LIBLIN','GLMFIT','MEXELM', 'DECTRE','RNDFOR','GLMNET','GRDBST','SEQOPT','WBLCOX', 'ELASVM'}))
