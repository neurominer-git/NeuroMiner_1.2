...
for i=1:nP % Loop through hyperparameter combinations
    ...
    % Do the magic
    if fromData
        [R(i), R95CI(:,i)] = compute_perf(IN.Nfeats, IN.Nmarkers, IN.Ncases(:,i), IN.eventprob, IN.AUCmax, IN.AUCmin, IN.Nbatches, IN.BatchPerc, IN.NcasesMiss, IN.NfeatsMiss, IN.algorithm, IN.RAND, IN.verbose, IN.Data, IN.DataLabel, IN.NRanalysis, IN.add2orig);
    else
